...
pc_fetcher::pc_fetcher(){
   ...
   ros::Subscriber _imSub1 = _slaveRobot.subscribe("/image_converter/front_video", 30, &pc_fetcher::im1Callback, this);
   ros::Subscriber _imSub2 = _slaveRobot.subscribe("/image_converter/back_video", 30, &pc_fetcher::im2Callback, this);
