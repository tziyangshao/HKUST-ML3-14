...
class pc_fetcher{
	...
	void im1Callback(slave_robot::keyframeMsgConstPtr msg);
	void im2Callback(slave_robot::keyframeMsgConstPtr msg);
	sensor_msgs::PointCloud omnicloud;
	sensor_msgs::PointCloud2 omnicloud2;
