...
void pc_Callback(slave_robot::keyframeMsgConstPtr msg){
	...
	for(int y=1;y<height-1;y++){
		for(int x=1;x<width-1;x++){
			...
			/*
			value.float_pc=pt[0];
			pointcloud.data[0]=value.bytes.pc_0;
			pointcloud.data[1]=value.bytes.pc_1;
			pointcloud.data[2]=value.bytes.pc_2;
			pointcloud.data[3]=value.bytes.pc_3;
			value.float_pc=pt[1];
			pointcloud.data[4]=value.bytes.pc_0;
			pointcloud.data[5]=value.bytes.pc_1;
			pointcloud.data[6]=value.bytes.pc_2;
			pointcloud.data[7]=value.bytes.pc_3;
			value.float_pc=pt[2];
			pointcloud.data[8]=value.bytes.pc_0;
			pointcloud.data[9]=value.bytes.pc_1;
			pointcloud.data[10]=value.bytes.pc_2;
			pointcloud.data[11]=value.bytes.pc_3;
			*/		
			value.float_pc=pt[0];
			pointcloud.data[0+countpoint*12]=value.bytes.pc_0;
			pointcloud.data[1+countpoint*12]=value.bytes.pc_1;
			pointcloud.data[2+countpoint*12]=value.bytes.pc_2;
			pointcloud.data[3+countpoint*12]=value.bytes.pc_3;
			value.float_pc=pt[1];
			pointcloud.data[4+countpoint*12]=value.bytes.pc_0;
			pointcloud.data[5+countpoint*12]=value.bytes.pc_1;
			pointcloud.data[6+countpoint*12]=value.bytes.pc_2;
			pointcloud.data[7+countpoint*12]=value.bytes.pc_3;
			value.float_pc=pt[2];
			pointcloud.data[8+countpoint*12]=value.bytes.pc_0;
			pointcloud.data[9+countpoint*12]=value.bytes.pc_1;
			pointcloud.data[10+countpoint*12]=value.bytes.pc_2;
			pointcloud.data[11+countpoint*12]=value.bytes.pc_3;
			countpoint++;
			}
		}
 	myfile.close();
	pointcloud.width=countpoint;
	file_count++;
